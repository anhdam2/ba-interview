...
```bash
git clone https://github.com/anhdam2/ba-interview.git
cd ba-interview
chmod +x setup.sh
./setup.sh
```
...
├── references/
│   ├── question-bank.md               # 709 lines — Categories 1-13
│   ├── scoring-template.md            # 189 lines — scale, level matrix, output format
│   └── stimulation-leadership.md      # 261 lines — Categories 14-15
└── scripts/
